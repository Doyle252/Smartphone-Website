...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Họ và tên" maxlength="20"  class="box" value="<?= $fetch_profile["name"]; ?>">
      ...
      <input type="password" name="cpass" placeholder="Xác nhận lại mật khẩu" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
