...
<section class="contact">
   ...
   <form action="" method="post">
      <h3>Phản hồi</h3>
      <input type="text" name="name" placeholder="Họ và tên" required maxlength="20" class="box">
      ...
      <textarea name="msg" class="box" placeholder="Phản hồi của bạn" cols="30" rows="10"></textarea>
